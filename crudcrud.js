...
function onSubmit(e){
    ...
    axios.post("https://crudcrud.com/api/13b4b0d34dfc43889ceca826a5d83b14/appointmentData",userDetails)
    .then((response)=>{
...
window.addEventListener("DOMContentLoaded",()=>{
    axios.get("https://crudcrud.com/api/13b4b0d34dfc43889ceca826a5d83b14/appointmentData")
    .then((response)=>{
        console.log(response)
